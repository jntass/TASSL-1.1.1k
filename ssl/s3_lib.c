...
int ssl_derive_SM2(SSL *s, EVP_PKEY *privkey, EVP_PKEY *pubkey,  int gensecret)
{
...
#ifdef STD_ZAZB
    if (1 != EVP_PKEY_CTX_set_responsor(pctx, s->server) || //���ܱ�׼����ZAZB
#else
    if (1 != EVP_PKEY_CTX_set_responsor(pctx, !s->server) || //���ܾ�Ĭ��˳��ZBZA
#endif
    ...
    local_e_sm4 = ENGINE_get_cipher_engine(NID_sm4_cbc);        //���������SM4���棬��Э�����ĵ�premasterkey�����û�м�����Э�����ĵ�premasterkey
    if (local_e_sm4)
    ...
    if (gensecret) {
        ...
        if (SSL_IS_TLS13(s)) {
            ...
            if(local_evp_ptr && local_e_sm4){
                if(local_e_sm2){
                    ENGINE_set_tass_flags(local_e_sm4, TASS_FLAG_PRE_MASTER_KEY_CIPHER);       //����SM2�����ECDHE-SM4-SM3�׼��������ĵ�premasterkey; ������SM2�����Ϊ����premasterkey
                    set_engine_flag = 1;
                }

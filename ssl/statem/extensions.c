...
static const EXTENSION_DEFINITION ext_defs[] = {
...
#endif
    {
        ...
        SSL_EXT_CLIENT_HELLO | SSL_EXT_TLS1_2_SERVER_HELLO
        | SSL_EXT_TLS1_2_AND_BELOW_ONLY | SSL_EXT_SM1_1_NOT_ALLOWED, /* TODO: SM4 engine not support this extension*/
...
#ifndef OPENSSL_NO_EC
    {
        ...
        SSL_EXT_CLIENT_HELLO | SSL_EXT_TLS1_3_SERVER_HELLO
        | SSL_EXT_TLS1_3_HELLO_RETRY_REQUEST | SSL_EXT_TLS1_3_ONLY,
...
int extension_is_relevant(SSL *s, unsigned int extctx, unsigned int thisctx)
{
    ...
    if ((thisctx & SSL_EXT_TLS1_3_HELLO_RETRY_REQUEST) != 0)
        ...
        is_tls13 = SSL_IS_TLS13(s) || SSL_IS_DTLS13(s);
                         ...
                         int max_version)
{
    ...
    if (!extension_is_relevant(s, extctx, thisctx)
            ...
            || (max_version == SM1_1_VERSION && (extctx & SSL_EXT_SM1_1_NOT_ALLOWED) != 0))
        return 0;
...
static int final_sig_algs(SSL *s, unsigned int context, int sent)
{
    if (!sent && (SSL_IS_TLS13(s) || SSL_IS_DTLS13(s)) && !s->hit) {
